      ...
      >
        ...
        >
          ...
          >
            ...
            <h5 style={{margin: 0, color: "#313131", fontSize: isMobile ? "12px" : "14px",}}> USD 0101241960112</h5>
          </div>
           <div style={{ display: "flex", flexDirection: "column", marginTop: "20px", alignItems: "center" , textAlign: "center", gap: "6px"}}>
              <h1 style={{margin: 0,}}>Thank you for your prayers and support. </h1>
              <h1 style={{margin: 0,}}>May God bless you abundantly!</h1>
            </div>
        </div>
      </div>
    </>
